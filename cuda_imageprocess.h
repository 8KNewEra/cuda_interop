...
public:
    ...
    bool calc_histgram(uint32_t* d_hist_r,uint32_t* d_hist_g,uint32_t* d_hist_b,unsigned int* d_max_r,unsigned int* d_max_g,unsigned int* d_max_b,cudaTextureObject_t texObj,int width,int height);
    ...
    bool copy_histgram_vbo(float* vbo,int num_bins,const unsigned int* hist_r,const unsigned int* hist_g,const unsigned int* hist_b,unsigned int* d_max_r,unsigned int* d_max_g,unsigned int* d_max_b);
};
