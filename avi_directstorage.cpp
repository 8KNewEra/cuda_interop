...
// ffmpeg初期化（CPU）
bool avi_directstorage::initialized_ffmpeg()
{
...
//フレームレートを取得する関数
double avi_directstorage::getFrameRate(AVFormatContext* fmt_ctx, int video_stream_index) {
...
//テストでコード、最終フレームpts取得
bool avi_directstorage::get_last_frame_pts() {
...
//オーディオ
void avi_directstorage::get_decode_audio(){
